...
const paragraphs = [
    "In the tranquil twilight, cicadas hummed rhythmically, harmonizing with rustling leaves. The sun's memory cast long shadows on cobblestones, as a lone figure strolled—a mysterious silhouette in the fading light. The painted sky in tangerine and lavender witnessed nature's ephemeral artistry, a delicate balance where day and night whispered tales of the unseen.",
    ...
    "Beneath the city's neon glow, a bustling metropolis awakens, its heartbeat pulsating with the rhythm of urban life. Skyscrapers reach for the heavens, reflecting the dreams of countless souls. Streetlights flicker, casting a vibrant glow on diverse faces and eclectic storefronts. In this mosaic of existence, each person contributes a unique brushstroke to the vibrant tapestry of urban existence.",
    ...
    "Amidst emerald hills and azure skies, a hidden hamlet thrives, its quaint charm untouched by time. The aroma of blooming wildflowers dances with the breeze, and laughter echoes through cobbled streets. Warm sunlight kisses rustic cottages, adorned with ivy and memories. Here, tranquility is a cherished resident, and the heartbeat of nature orchestrates a timeless symphony of serenity.",
